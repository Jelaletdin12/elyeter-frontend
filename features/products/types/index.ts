...
export type ProductTranslation = components['schemas']['ProductTranslationResponseDto'];
...
export type ProductVariant = Omit<components['schemas']['ProductVariantResponseDto'], 'attributes'> & {
